...
EPICv1.Indexes<- read.csv("Index EPIC v1 changed probes.csv")
EPICv1.Indexes <- EPICv1.Indexes$x

# List all directories of EPIC v1 Samples
List <- list.dirs("/home/minknow/EPIC_V1/", full.names = TRUE)
...
write.csv(df, "Changed Type I Probes EPIC v1.csv") 
write.csv(df2, "Changed Type II Probes EPIC v1.csv")
